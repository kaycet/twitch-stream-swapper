...
class NotificationManager {
  ...
  async notifyStreamLive(username, title, gameName, thumbnailUrl, viewerCount) {
    ...
    try {
      ...
      // Setup one-time listeners for this notification. All three are removed
      // when the notification closes for any reason (click, button, dismiss,
      // timeout) — previously the handlers leaked whenever a notification was
      // dismissed without being clicked.
      const cleanup = () => {
